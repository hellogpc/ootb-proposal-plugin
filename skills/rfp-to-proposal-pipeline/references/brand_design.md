...
## 8. Validation (Claude 자가검증 + 시각 QA)

별도 검증 스크립트는 없음. Claude 가 outline.yaml 작성 시 (`synthesis_guide.md` 체크리스트) + Step 6 렌더 직전 (아래 항목) + Step 7 시각 QA 의 3중 점검.
...
- Chart 에 axis labels + source line 있음
- 폰트는 Pretendard 만
- Logo 가 top-right, 추가 장식 없음
